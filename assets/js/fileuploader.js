...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onSubmit: function(id, fileName){
        ...
        document.getElementsByClassName("qq-upload-button")[0].setAttribute("upload_status", "uploading");
    ...
    _onComplete: function(id, fileName, result){
        ...
        document.getElementsByClassName("qq-upload-button")[0].setAttribute("upload_status", "finished");
